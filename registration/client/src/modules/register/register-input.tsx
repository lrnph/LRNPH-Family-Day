...
import { registerSchema, type Register} from '../../schemas';
...
import ClaimIntructions from './register-instructions';
...
const RegisterInput = () => {
  ...
  return (
    <section className="w-full flex flex-col relative items-center justify-center pb-8">
      ...
      <div className="flex flex-col max-w-[400px] mx-auto w-full items-center justify-center p-8">

...
const RegisterIntructions = ({ mode }: ClaimIntructionsProps) => {
  const instructions = mode === "QR Code" ? steps.QR : mode === "Manual" ? steps.Manual : [];

  return (
    <div className="w-full flex flex-col h-full items-center justify-center mt-4">
...
export default RegisterIntructions;
